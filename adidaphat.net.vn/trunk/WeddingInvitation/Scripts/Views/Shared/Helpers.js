/*
HUYDO:
HELPERS for convenient j-scripting
*/
...
Helper.prototype = function () {
    ...
    var stripOff = function stripOff(htmlText) {
...
NGUYENLQ:
*/
//Prevent Key IsNot Numberic
function PreventKeyIsNotNumberic(evt) {
    if (evt != 'undefined') {
