...
(function ($) {
    ...
    $.validator.addMethod('rangeDate', function (value, element, param) {
        ...
        try {
            var dateValue = $.datepicker.parseDate("mm/dd/yy", value); // hard-coding uk date format, but could embed this as an attribute server-side (based on the current culture)
        }
        catch (e) {
            return false;
        }
